...
void main() {
	...
	const char* nameR = "C:/Users/Виктория/folde for compseti/request.bin"; //файл для запросов клиентов
	const char* nameA = "C:/Users/Виктория/folde for compseti/answer.bin"; //файл для ответов сервера
	ofstream f_REQ;
	ifstream f_ANS;
	long pred_size;
	int answer;
